...
export type BaseUserFragment = { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'firstName' | 'lastName'>;
...
export type UsersQuery = { __typename?: 'Query' } & { users: Array<{ __typename?: 'User' } & BaseUserFragment> };
